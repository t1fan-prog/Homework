import timeit
from lesson26_task2 import FibonacciSearch
...
def fib_search(sequence, element):
    fs = FibonacciSearch()
    return fs.search(sequence, element)
...
if __name__ == "__main__":
    ...
    fib_timer = timeit.timeit(
        stmt="fib_search([-100, -1.5, 2, 3, 4, 6, 31, 101], 6)",
        number=100,
        setup="from __main__ import fib_search"
    )
    print(fib_timer)
